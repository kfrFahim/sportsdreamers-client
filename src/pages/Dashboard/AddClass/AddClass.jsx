     ...
     const onSubmit = data => {
          ...
          .then(imgResponse => {
              ...
              if(imgResponse.success){
                  ...
                  const newItem = {name, price: parseFloat(price), available_seats, instructor_name,instructor_email, image:imgURL , status:"pending", enrolledStudents : 0, feedback: "" , students:0 }
                  console.log(newItem)
